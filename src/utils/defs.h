...
#define GPH1CON        DEF(u32, 0xE0200C20)
#define GPH1DAT        DEF(u32, 0xE0200C24)
...
#define EXT_INT_1_CON  DEF(u32, 0xE0200E04)
#define EXT_INT_0_MASK DEF(u32, 0xE0200F00)
#define EXT_INT_1_MASK DEF(u32, 0xE0200F04)
#define EXT_INT_0_PEND DEF(u32, 0xE0200F40)
#define EXT_INT_1_PEND DEF(u32, 0xE0200F44)
